...
Same two options as Day 1: set up a free ADO org at `dev.azure.com` before the session, or capture these fields offline.

```
WORK ITEM TYPE: PBI (child of your Day 2 Feature)   — copy this block per PBI
Title:
Acceptance Criteria:
Tag: UX
Attached context (screen description):
```
